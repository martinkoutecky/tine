...
- # 2 — Links & references
- Page link: [[tine-guide/Welcome to Tine]] · tag: #demo · namespaced page: [[tine-guide/Features/Quick capture]].
- External link: [the Logseq docs](https://docs.logseq.com) · bare URL: https://logseq.com · autolinked email: <hello@example.com>.
- Labelled page link: [read the welcome]([[tine-guide/Welcome to Tine]]).
...
- {{embed [[tine-guide/Features/Tips & shortcuts]]}}
...
- {{query [[tine-guide/Welcome to Tine]]}}
- Query by priority:
- {{query (priority A)}}
