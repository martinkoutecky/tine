...
pub mod sqlite {
    ...
    pub use crate::sqlite_materialization::{
        ...
        PhysicalSourceCoverage, PhysicalTagRow, PhysicalTask, PhysicalTaskCandidatePageRow,
        PhysicalTaskRow, PhysicalTerminalCatalogStamp, PhysicalTerminalConstructionBatch,
