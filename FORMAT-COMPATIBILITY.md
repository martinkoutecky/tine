...
| SQLite projection | application ID `0x54494e45`; schema 17 | SQLite is disposable. A mismatch must rebuild from authoritative history, never reinterpret rows under a new schema. |
